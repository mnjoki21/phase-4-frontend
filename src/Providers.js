      ...
      <div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
        ...
        <h2 className="max-w-lg mb-6 font-sans text-3xl font-bold leading-none tracking-tight text-gray-900 sm:text-4xl md:mx-auto">
          <span className="relative inline-block">
            ...
            <span className="relative">Dedicated to providing</span>
          </span>{' '}
          the best services 
        </h2>
      ...
      <div className="grid max-w-md gap-10 row-gap-5 sm:row-gap-10 lg:max-w-screen-md lg:grid-cols-2 sm:mx-auto">
        <div className="flex flex-col justify-between p-5 bg-white border rounded shadow-sm">
          <div className="mb-6">
            <div className="flex items-center justify-between pb-6 mb-6 border-b">
              <div>
                ...
                <p className="text-5xl font-extrabold">Netflix</p>
              </div>
            </div>
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li className="flex items-center">
                  ...
                  <p className="font-medium text-gray-800">Variety of shows available</p>
                </li>
                <li className="flex items-center">
                  <div className="mr-2">
                    <svg
                  ...
                  <p className="font-medium text-gray-800">Affordable plans</p>
                </li>
              </ul>
            </div>
          </div>
          <div>
            <a
              href="/subscription"
              className="inline-flex items-center bg-yellow justify-center w-full h-12 px-6 mb-4 font-medium tracking-wide text-white transition duration-200 bg-gray-800 rounded shadow-md hover:bg-gray-900 focus:shadow-outline focus:outline-none"
            >
        ...
        <div className="flex flex-col justify-between p-5 bg-white border rounded shadow-sm">
          <div className="mb-6">
            <div className="flex items-center justify-between pb-6 mb-6 border-b">
              <div>
                ...
                <p className="text-5xl font-extrabold">Rent</p>
              </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li className="flex items-center">
                  ...
                  <p className="font-medium text-gray-800">Affordable Housing</p>
                </li>
                <li className="flex items-center">
                  <div className="mr-2">
                    <svg
                  ...
                  <p className="font-medium text-gray-800">
                    Constatnt electricity and water 
                  </p>
                </li>
                <li className="flex items-center">
                  <div className="mr-2">
                  ...
                  <p className="font-medium text-gray-800">Good security</p>
                </li>
              </ul>
            </div>
          </div>
          <div>
            <a
              href="/subscription"
              className="inline-flex  bg-yellow items-center justify-center w-full h-12 px-6 mb-4 font-medium tracking-wide text-white transition duration-200 rounded shadow-md bg-deep-purple-accent-400 hover:bg-deep-purple-accent-700 focus:shadow-outline focus:outline-none"
            >
              Add Subscription here
                      </a>
